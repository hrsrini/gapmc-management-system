...
|--------|----------------------|--------|----------|
| §1.4 | Employee–User ID coupling | Partial | `employees.user_id`, `users.employee_id`; `HrEmployeeDetail` Login & roles + `POST|PUT /api/hr/employees/:id/login`; HR deactivate on separation |
